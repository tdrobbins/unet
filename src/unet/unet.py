...
class ConvBlock(layers.Layer):
    ...
    def call(self, inputs, training=None, **kwargs):
        ...
        if self.normalization:
            x = self.normalization_1(x, training = training)
        ...
        if self.normalization:
            x = self.normalization_2(x, training = training)
...
def build_model(nx: Optional[int] = None,
                ...
                normalization: bool = False) -> Model:
    """
    ...
    :param normalization: whether to use batch normalization
